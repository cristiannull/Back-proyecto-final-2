...
await VideoGame.create({
  ...
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: [
    "https://images-na.ssl-images-amazon.com/images/I/91lmTAVXgHL.jpg",
...
await VideoGame.create({
  ...
  price: 60,
  description:
    " es un juego de acción y aventura de 2005 para PS2. Sigues a Kratos, un guerrero espartano que busca venganza contra el dios Ares en la antigua Grecia. Combina combates intensos y resolución de acertijos.",
});
...
await VideoGame.create({
  ...
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: [
    "https://gamefaqs.gamespot.com/a/box/8/5/3/746853_front.jpg", 
...
await VideoGame.create({
  ...
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: [
    "https://cdr.cz/sites/default/files/dark_souls_iii_-_image_01.jpg",
...
await VideoGame.create({
  ...
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: [
    "https://i.blogs.es/0f6803/jfo_key_deluxe_rgb/1366_2000.jpeg", 
