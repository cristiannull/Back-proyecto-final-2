...
await VideoGame.create({
  ...
  price: 12,
  description:
    " Un juego de puzzles en primera persona desarrollado por Valve. Los jugadores utilizan una pistola de portales para crear portales interconectados y resolver una serie de desafiantes rompecabezas. La narrativa y los personajes humorísticos son muy apreciados.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c929d5b0a90daa03fe31",
  image: "https://media.vandal.net/m/79436/halo-reach-201912316245316_2.jpg",
  price: 12,
  description:
    "Una precuela de la serie Halo que cuenta la historia del equipo Noble, un grupo de soldados espartanos, y su lucha desesperada para salvar el planeta Reach de la invasión del Covenant. Es valorado por su campaña emotiva y multijugador robusto.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://media.vandal.net/m/36874/resident-evil-4-201683095332_1.jpg",
  price: 35,
  description:
    "Un juego de horror y supervivencia que sigue a Leon S. Kennedy en una misión para rescatar a la hija del presidente de Estados Unidos de un culto siniestro en una remota aldea europea. Es famoso por reinventar la serie con su enfoque en la acción y su innovador sistema de cámara.",
});
...
await VideoGame.create({
  ...
  price: 18,
  description:
    "¡Disfruta un juego totalmente nuevo de acción y aventura, inspirado en los títulos clásicos de exploración de mazmorras y basado en el universo de Minecraft!",
});
...
await VideoGame.create({
  ...
  price: 0,
  description:
    "Un juego de batalla real donde los jugadores compiten para ser el último en pie en una isla llena de peligros.",
});
...
await VideoGame.create({
  ...
  price: 60,
  description:
    "Una aventura de plataformas en 3D donde Mario viaja por varios mundos para rescatar a la princesa Peach.",
});
...
await VideoGame.create({
  ...
  price: 60,
  description:
    "Un juego de acción y aventura ambientado en el Lejano Oeste donde el jugador sigue la historia de Arthur Morgan.",
});
...
await VideoGame.create({
  ...
  price: 40,
  description:
    "Un RPG de mundo abierto donde el jugador controla a Geralt de Rivia en su búsqueda para encontrar a su hija adoptiva.",
});
...
await VideoGame.create({
  ...
  price: 40,
  description:
    "Un juego de disparos en equipo donde los jugadores eligen héroes con habilidades únicas para competir en diversos modos de juego.",
});
...
await VideoGame.create({
  ...
  developer: "6647c8f0d5b0a90daa03fe2d",
  image:
    "https://media.vandal.net/m/65557/animal-crossing-new-horizons-202011012375667_1.jpg",
  price: 60,
  description:
    "Un juego de simulación social donde los jugadores desarrollan y personalizan su propia isla.",
});
...
await VideoGame.create({
  ...
  price: 60,
  description:
    "Un juego de disparos en primera persona lleno de acción donde el jugador combate hordas de demonios.",
});
...
await VideoGame.create({
  ...
  price: 20,
  description:
    "Un juego de acción y aventura ambientado en una ciudad ficticia inspirada en Miami en los años 80.",
});
...
await VideoGame.create({
  ...
  price: 60,
  description:
    "Un juego de disparos en primera persona que sigue la historia del Master Chief en su lucha contra el Covenant.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://images-na.ssl-images-amazon.com/images/I/91lmTAVXgHL.jpg",
  price: 60,
  description:
    "Un juego de acción y aventura donde el jugador controla a un vikingo explorando la Inglaterra del siglo IX.",
});
...
await VideoGame.create({
  ...
  price: 25,
  description:
    "Un juego de acción roguelike donde el jugador controla a Zagreus en su intento de escapar del Inframundo.",
});
...
await VideoGame.create({
  ...
  price: 5,
  description:
    "Un juego multijugador de deducción social donde los jugadores deben identificar al impostor en la nave espacial.",
});
...
await VideoGame.create({
  ...
  price: 60,
  description:
    "Un juego de acción y aventura ambientado en el Japón feudal donde el jugador controla a un samurái en su lucha contra los invasores mongoles.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://images-na.ssl-images-amazon.com/images/I/81gXqxyFrxL.jpg",
  price: 60,
  description:
    "Un juego de acción y aventura que sigue la historia de Kratos y su hijo Atreus en la mitología nórdica.",
});
...
await VideoGame.create({
  ...
  price: 60,
  description:
    "Un juego de disparos en tercera persona donde los jugadores compiten para cubrir el mayor área posible con tinta.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://gamefaqs.gamespot.com/a/box/8/5/3/746853_front.jpg",
  price: 60,
  description:
    "Una versión modernizada del clásico juego de rol japonés con gráficos mejorados y un sistema de combate actualizado.",
});
...
await VideoGame.create({
  ...
  price: 40,
  description:
    "Un RPG de mundo abierto donde los jugadores pueden explorar y vivir aventuras en la tierra de Skyrim.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://gamepreorders.com/wp-content/uploads/2019/03/cover-art-6.jpg",
  price: 30,
  description:
    "Un juego de acción y aventura donde el jugador investiga fenómenos sobrenaturales en una misteriosa agencia gubernamental.",
});
...
await VideoGame.create({
  ...
  developer: "6647c8f0d5b0a90daa03fe2d",
  image:
    "https://th.bing.com/th/id/R.7f9bbcca499b8c51fc7c5174d0ea2290?rik=5LwRTZAQLwEw0w&pid=ImgRaw&r=0",
  price: 40,
  description:
...
await VideoGame.create({
  ...
  price: 30,
  description:
    "Un juego de rol de acción donde los jugadores cazan monstruos gigantes en un mundo abierto.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://i.blogs.es/0f6803/jfo_key_deluxe_rgb/1366_2000.jpeg",
  price: 60,
  description:
    "Un juego de acción y aventura donde el jugador controla a un Jedi en su lucha contra el Imperio.",
});
...
await VideoGame.create({
  ...
  price: 20,
  description:
    "Un juego de plataformas y disparos con un estilo artístico inspirado en los dibujos animados de los años 30.",
});
...
await VideoGame.create({
  ...
  theme: "66484bf01593a60f58e0c0a3",
  developer: "6647c8f0d5b0a90daa03fe2d",
  image: "https://assets.vg247.com/current/2019/02/apex_legends_main_art_2.jpg",
  price: 0,
  description:
