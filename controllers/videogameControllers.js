...
async function create(req, res) {
  ...
  async function find(req, res) {
    try {
      ...
      const game = await videoGame.findById(gameId).populate("category","pegi", "gender", "theme", "image");
  ...
  async function list(req, res) {
    try {
      const gameList = await videoGame.find().populate("category","pegi", "gender", "theme", "image");
  ...
  async function update(req, res) {
    try {
      ...
      gameEncontrado.description = req.body.description || gameEncontrado.description;
